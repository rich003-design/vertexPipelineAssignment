...
Select or create a GCP project: Follow the instructions here to create a GCP project. Also, enable billing for your project.

Activate Vertex AI on GCP: To use Vertex AI, you will need to enable the Vertex AI API on your GCP account. Follow the instructions in the official documentation to activate Vertex AI.

Create a Google Storage Bucket: You will need to create a Google Storage Bucket to store the data and artifacts generated by the pipeline. Follow the instructions in the official documentation to create a bucket.

Usage
To run the pipeline, follow these steps:

Clone the repository to your GCP VM instance.
Create a virtual Python environment: You should create a virtual Python environment to run the code in this repository. Follow the instructions here to create a virtual environment using virtualenv.
Activate the virtual environment: Activate the virtual environment you created in Step 2.
source /path/to/venv/bin/activate
Install the required packages in your activated virtual environment:
pip install google-cloud-aiplatform
pip install kfp
Select your virtual environment as your kernel in the Jupyter Notebook (custom_vertex_ai_pipelines.ipynb): You can use ipykernel to add the virtual environment to your notebook.
Build custom training and serving container images: Before you can run the notebook/pipeline, you would also need to build custom training and serving container images. Follow the instructions in the [article] to build your custom container images.
...
Further Reading
For a more detailed description and step-by-step guidelines, please refer to my Medium article where I explain how to create and deploy a custom GCP Vertex AI pipeline.)
